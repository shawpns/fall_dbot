...
@bot.event
async def on_ready():
    activity = discord.Game(name="YouTube", type=1)
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name="PUBGM Funny Videos On YouTube...... Just Type '+help' for Disturbing Me"))
